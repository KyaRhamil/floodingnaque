...
def main():
    parser = argparse.ArgumentParser(
        description='Manage time-series table partitions for Floodingnaque'
    )
    
    parser.add_argument(
        '--create', '-c',
        action='store_true',
        help='Create future partitions'
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=3,
        help='Months ahead to create partitions (default: 3)'
    )
    
    parser.add_argument(
        '--cleanup', '-d',
        action='store_true',
        help='Drop old partitions based on retention policy'
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=24,
        help='Months to retain partitions (default: 24)'
    )
    
    parser.add_argument(
        '--stats', '-s',
        action='store_true',
        help='Show partition statistics'
    )
    
    parser.add_argument(
        '--all', '-a',
        action='store_true',
        help='Run all operations: create, cleanup, and stats'
    )
