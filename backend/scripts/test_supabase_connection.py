...
def test_connection():
    ...
    if 'YOUR_DATABASE_PASSWORD' in db_url:
        ...
        print("1. Go to: https://supabase.com/dashboard/project/ckazvlqipxqdmwqakxue/settings/database")
        print("2. Copy your database password")
        print("3. Replace 'YOUR_DATABASE_PASSWORD' in the DATABASE_URL in .env")
        print("\nExample DATABASE_URL format:")
        print("postgresql://postgres.ckazvlqipxqdmwqakxue:YOUR_ACTUAL_PASSWORD@aws-0-ap-southeast-1.pooler.supabase.com:6543/postgres")
        return False
