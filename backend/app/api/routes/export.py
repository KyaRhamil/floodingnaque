...
from app.models.db import WeatherData, Prediction, get_db_session
...
def export_weather():
    ...
    try:
        ...
        if limit > max_limit:
            return jsonify({
                'error': f'Limit exceeds maximum of {max_limit}'
            }), 400
        ...
        if export_format == 'csv':
            ...
            writer.writerow([
                ...
                'wind_speed', 'pressure', 'latitude', 'longitude', 'location'
            ])
    ...
    try:
        ...
        if export_format == 'csv':
            ...
            writer.writerow([
                ...
                'temperature', 'humidity', 'precipitation', 'model_version'
            ])
