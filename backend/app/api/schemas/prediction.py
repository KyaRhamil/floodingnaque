...
class PredictRequestSchema:
    ...
    def to_prediction_dict(self) -> dict:
        ...
        return {"temperature": self.temperature, "humidity": self.humidity, "precipitation": self.precipitation}
...
class PredictResponseSchema:
    ...
    def to_dict(self) -> dict:
        ...
        response = {"prediction": self.prediction, "flood_risk": self.flood_risk, "request_id": self.request_id}
    ...
    def from_prediction(cls, prediction: Any, request_id: str) -> "PredictResponseSchema":
        ...
        if isinstance(prediction, dict):
            ...
            return cls(prediction=prediction, flood_risk="high" if prediction == 1 else "low", request_id=request_id)
