...
class TestBatchPredictEndpoint:
    ...
    def test_batch_predict_exceeds_max_size(self, client):
        ...
        predictions = [{"temperature": 298.15, "humidity": 65, "precipitation": 5.0} 
                       for _ in range(101)]
...
class TestBatchPredictValidation:
    ...
    def test_missing_humidity(self, client):
        ...
        data = {
            "predictions": [
                {"temperature": 298.15, "precipitation": 5.0}
            ]
        }
    ...
    def test_missing_precipitation(self, client):
        ...
        data = {
            "predictions": [
                {"temperature": 298.15, "humidity": 65}
            ]
        }
    ...
    def test_invalid_data_types(self, client):
        ...
        data = {
            "predictions": [
                {"temperature": "hot", "humidity": 65, "precipitation": 5.0}
            ]
        }
...
class TestBatchPredictResultFormat:
    ...
    def test_result_contains_required_fields(self, client):
        ...
        data = {
            "predictions": [
                {"temperature": 298.15, "humidity": 65, "precipitation": 5.0, "location": "Test"}
            ]
        }
