...
class TestClassifyRiskLevel:
    ...
    def test_alert_level_no_flood_moderate_probability(self):
        ...
        result = classify_risk_level(
            prediction=0,
            probability={'no_flood': 0.65, 'flood': 0.35}
        )
    ...
    def test_alert_level_flood_moderate_probability(self):
        ...
        result = classify_risk_level(
            prediction=1,
            probability={'no_flood': 0.40, 'flood': 0.60}
        )
    ...
    def test_safe_low_humidity_low_precipitation(self):
        ...
        result = classify_risk_level(
            prediction=0,
            probability={'no_flood': 0.90, 'flood': 0.10},
            precipitation=2.0,
            humidity=50.0
        )
    ...
    def test_confidence_calculation_critical(self):
        ...
        result = classify_risk_level(
            prediction=1,
            probability={'no_flood': 0.10, 'flood': 0.90}
        )
...
class TestFormatAlertMessage:
    ...
    def test_safe_message_no_extra_warning(self):
        ...
        risk_data = {
            'risk_label': 'Safe',
            'description': 'No immediate flood risk.',
            'confidence': 0.90
        }
...
class TestRiskClassificationEdgeCases:
    ...
    def test_boundary_probability_030(self):
        ...
        result = classify_risk_level(
            prediction=0,
            probability={'no_flood': 0.70, 'flood': 0.30}
        )
    ...
    def test_boundary_probability_075(self):
        ...
        result = classify_risk_level(
            prediction=1,
            probability={'no_flood': 0.25, 'flood': 0.75}
        )
    ...
    def test_low_precipitation_no_alert(self):
        ...
        result = classify_risk_level(
            prediction=0,
            probability={'no_flood': 0.85, 'flood': 0.15},
            precipitation=9.9  # Just below threshold
        )
...
class TestRiskClassificationParameterized:
    ...
    @pytest.mark.parametrize("prediction,flood_prob,expected_level,expected_label", [
        # Safe cases
        (0, 0.05, 0, 'Safe'),
        (0, 0.10, 0, 'Safe'),
        (0, 0.20, 0, 'Safe'),
