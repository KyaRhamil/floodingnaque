...
class TestBodySizeLimits:
    ...
    def test_default_limits_exist(self):
        ...
        from app.api.middleware.body_size import DEFAULT_LIMITS
    ...
    def test_get_body_size_limit_default(self):
        ...
        from app.api.middleware.body_size import DEFAULT_LIMITS, get_body_size_limit
    ...
    def test_get_body_size_limit_from_env(self):
        ...
        from app.api.middleware.body_size import get_body_size_limit
...
class TestLimitBodySizeDecorator:
    ...
    def test_decorator_with_endpoint_type(self):
        ...
        from app.api.middleware.body_size import limit_body_size
