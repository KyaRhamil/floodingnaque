...
from tests.strategies import (
    weather_data, extreme_weather_data, model_prediction_output,
    flood_probability, probability_dict, risk_level, risk_label
)
...
class TestPropertyBasedModelOutputValidation:
    ...
    def test_prediction_output_structure(self, output):
        ...
        required_fields = [
            'prediction', 'flood_risk', 'risk_level', 'risk_label',
            'confidence', 'probability', 'model_version', 'model_name'
        ]
    ...
    def test_exact_threshold_values(self):
        ...
        for prob, expected_level in test_cases:
            result = classify_risk_level(
                ...
                probability={'no_flood': 1 - prob, 'flood': prob}
            )
