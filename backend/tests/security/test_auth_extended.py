...
class TestAuthMiddlewareUnit:
    ...
    def test_is_using_bcrypt(self):
        ...
        from app.api.middleware.auth import is_using_bcrypt, BCRYPT_AVAILABLE
...
class TestRateLimiting:
    ...
    def test_rate_limit_headers_present(self):
        ...
        # (May not be present if rate limiting is disabled)
...
class TestSecurityHeaders:
    ...
    def test_no_server_version_disclosure(self):
        ...
        assert not re.search(version_pattern, server_header), \
            f"Server header may disclose version: {server_header}"
