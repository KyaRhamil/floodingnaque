...
def downgrade():
    ...
    # Drop satellite precipitation columns from weather_data
    op.drop_column('weather_data', 'dataset')
    op.drop_column('weather_data', 'data_quality')
    op.drop_column('weather_data', 'precipitation_24h')
    op.drop_column('weather_data', 'precipitation_3h')
    op.drop_column('weather_data', 'precipitation_1h')
    op.drop_column('weather_data', 'satellite_precipitation_rate')
